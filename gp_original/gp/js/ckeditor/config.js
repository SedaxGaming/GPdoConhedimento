CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Underline,Subscript,Superscript,Link,Unlink,Anchor,HorizontalRule,Source,NumberedList,BulletedList,About';
};
