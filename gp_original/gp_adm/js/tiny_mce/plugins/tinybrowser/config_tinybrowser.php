...
$tinybrowser['path']['image'] = '/gp/imgquestoes/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/gp/imgquestoes/media/'; // Media files location
$tinybrowser['path']['file']  = '/gp/imgquestoes/files/'; // Other files location
